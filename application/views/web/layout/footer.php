                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <ul class="des">
                                        ...
                                        </li><?php echo 'Cidade: '.$sistema->sistema_cidade.'/'.$sistema->sistema_estado?>
                                        <li>
                                            <span>Contato: </span>
                                            <br>
                                            <?php echo 'Whatsapp: '.$sistema->sistema_telefone_movel?>
                                            <br>
                                            <?php echo 'Fone: '.$sistema->sistema_telefone_fixo?>
                                        </li>
                                        <li>
                                            <span>Email: </span>
                                            <a href="<?php echo $sistema->sistema_email?>"><?php echo $sistema->sistema_email?></a>
                                        </li>
                                    </ul>
                                </div>
